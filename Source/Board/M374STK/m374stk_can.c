...
static can_message Message_Composer(can_group Group, can_sub_group SubGroup)
{
  ...
  case STATUS_INFORMATION:                                                    /* Group 2: Status Information */
    ...
    case STATUS_INFORMATION_SPEED_TORQUE_CURRENT:                             /* SubGrp m.1.2: Speed Information */
      ...
      message.Data.w[3] = TEE_VE1->VDC * ChannelValues[USE_CHANNEL].v_max / (0xfff<<3);
      message.dlc  = 8;
      break;
    ...
    case CONFIGURATION_INFORMATION:                                           /* Group 6: Configuration Information */
      ...
      case CONFIGURATION_INFORMATION_MAX_VA:                                  /* SubGrp m.2.6: Max Voltage, Current, Acceleration Data */
        message.Data.w[0]= ChannelValues[USE_CHANNEL].v_max*1000;             /* MaxVoltage */
        message.Data.w[1]= ChannelValues[USE_CHANNEL].a_max;                  /* MaxCurrent */
      ...
      case CONFIGURATION_INFORMATION_TORQUE:                                  /* SubGrp m.3.6: Torque Factor */
        message.Data.w[0]= MotorParameterValues[USE_CHANNEL].TorqueFactor/10; /* Torque Factor */
        message.dlc      = 2;
        break;
      default:
        break;
...
static void CAN_Init(void)
{
  ...
  MCP2515_WriteBitTimingRegister(CNF1_0125_16MHz,                             /* CAN Bus timing for 125 MHz at 16 MHz clock */
                                 CNF2_0125_16MHz,
                                 CNF3_0125_16MHz);
