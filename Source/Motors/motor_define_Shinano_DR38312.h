...
/* Motor Parameter */
#define	MOTOR_POLE_PAIRS          6                 /* NONE             - Half of Poles */
...
#define	MOTOR_ANGULAR_ACC_MAX     200               /* [rev/sec^2]      - max angular velocity */
#define	MOTOR_TORQUE_MAX          51                /* [mNm/A]          - max torque value */
#define MOTOR_RESISTANCE          1350              /* [mOhm]           - Winding resistance */
#define MOTOR_INDUCTANCE          1200              /* [uH]             - Winding inductance */
#define MOTOR_HZ_LIMIT            200               /* [Hz]             - Limitation speed of motor */
#define MOTOR_HZ_CHANGE           40                /* [Hz]             - Max Forced speed of motor (no FOC) */
#define MOTOR_INIT_DELAY          100               /* [ms]             - Time of Positioning Stage */
#define MOTOR_IQ_START            1000              /* [mA]             - Start current (Iq) */
#define MOTOR_ID_START            1000              /* [mA]             - Start current (Id) */
#define MOTOR_IQ_LIM              1800              /* [mA]             - q-axis limitation current */
#define	MOTOR_ID_LIM              1700              /* [mA]             - d-axis limitation current */
#define MOTORID                   "Shinano DR38312" /* max 20 characters */

/* Control Loop Parameter */
#define CONTROL_ID_KI             4                 /* [V/As]           - d-axis current control Integral gain */
#define CONTROL_ID_KP             3                 /* [V/A]            - d-axis current control Proportional gain */
#define CONTROL_IQ_KI             4                 /* [V/As]           - q-axis current control Integral gain */
#define CONTROL_IQ_KP             3                 /* [V/A]            - q-axis current control Proportional gain */
