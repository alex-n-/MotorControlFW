...
/* Motor Parameter */
#define	MOTOR_POLE_PAIRS          5                 /* NONE             - Half of Poles */
...
#define	MOTOR_TORQUE_MAX          330               /* [mNm/A]          - max torque value */
#define MOTOR_RESISTANCE          3460              /* [mOhm]           - Winding resistance */
#define MOTOR_INDUCTANCE          5000              /* [uH]             - Winding inductance */
#define MOTOR_HZ_LIMIT            333               /* [Hz]             - Limitation speed of motor */
#define MOTOR_HZ_CHANGE           30                /* [Hz]             - Max Forced speed of motor (no FOC) */
#define MOTOR_INIT_DELAY          100               /* [ms]             - Time of Positioning Stage */
#define MOTOR_IQ_START            600               /* [mA]             - Start current (Iq) */
#define MOTOR_ID_START            600               /* [mA]             - Start current (Id) */
#define MOTOR_IQ_LIM              1500              /* [mA]             - q-axis limitation current */
#define	MOTOR_ID_LIM              1500              /* [mA]             - d-axis limitation current */
#define MOTORID                   "Shinano PMBA200-FK"  /* max 20 characters */
