...
#define IS_ADC_UNIT(param)          (((param) == TSB_ADA) || \
                                     ((param) == TSB_ADB))
...
#define IS_ADC_PRESCALER(param)     (((param) == ADC_FC_DIVIDE_LEVEL_NONE) || \
...
/** 
  ...
  */
    typedef struct {
        ADC_CMPCRx CMPCRx;      /*!< Select ADC_CMPCR_0 for ADxCMPCR0 or ADC_CMPCR_1 for ADxCMPCR1 */
        ...
        uint32_t CmpValue;      /*!< Comparison value to be set in ADxCMP0 or ADxCMP1, max value is 4095 */
    } ADC_MonitorTypeDef;
...
/* PMD_PROGx to be set for ADxPSELn, use with macro TRG_ENABLE() and TRG_DISABLE() */
...
/**
  ...
  */
    typedef struct {
        PMD_PROGx ProgNum;      /*!< select PMD_PROG0 to PMD_PROG5 for ADxPSETn , (x = A, B; n = 0 to 5) */
        ...
        uint8_t Reg0_AINx;      /*!< select AI channel together with its enabled or disabled setting for REG0 in ADxPSETn */
        uint8_t Reg1_AINx;      /*!< select AI channel together with its enabled or disabled setting for REG1 in ADxPSETn */
        uint8_t Reg2_AINx;      /*!< select AI channel together with its enabled or disabled setting for REG2 in ADxPSETn */
        uint8_t Reg3_AINx;      /*!< select AI channel together with its enabled or disabled setting for REG3 in ADxPSETn */
    } PMD_TrgTypeDef;
