 ...
 ****************************************************************************
 * @file    tmpm375_adc.h
 * @brief   This file provides all the functions prototypes for M375 ADC driver.
 * @version V2.0.2.1
 * @date    2013/01/21
 *
...
#ifndef __TMPM375_ADC_H
#define __TMPM375_ADC_H
...
#define ADC_HOLD_FIX                ((uint32_t)0x09U << 3U)     /* must write 0x1001 to this area */
...
/**
  ...
  */
    typedef struct {
        ...
        ADC_CMPCRx CMPCRx;      /*!< Select ADC_CMPCR_0 for ADxCMPCR0 or ADC_CMPCR_1 for ADxCMPCR1  x = B */
        ...
        ADC_CmpCondition Condition;     /*!< Conditon to compare ADxREGm with ADxCMPn. (x = B; m = 0 to 11; n = 0, 1) */
        uint32_t CmpValue;      /*!< Comparison value to be set in ADxCMP0 or ADxCMP1, max value is 4095 . ( x = B ) */
    } ADC_MonitorTypeDef;
...
#define IS_PMD_INT_NAME(param)   ( ((param) == PMD_INTNONE) || ((param) == PMD_INTADPDB) )
    ...
    typedef enum {
        ADC_AIN9 = 9U,          /*!< define for Analog Input channel */
        ADC_AIN10 = 10U,
        ADC_AIN11 = 11U,
        ADC_AIN12 = 12U,
        ADC_AIN16 = 16U
...
#define IS_UNIT_B_AINx(param)   ((((param) >= TRG_ENABLE(ADC_AIN9)) && \
...
/**
  ...
  */
    typedef struct {            /* in ADxPSETn below: ( x = B ; n = 0 to 5 ) */
