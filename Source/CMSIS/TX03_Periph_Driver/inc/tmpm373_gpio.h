...
#ifndef __TMPM373_GPIO_H
#define __TMPM373_GPIO_H
...
#define GPIO_PA_OUTPUT_BIT_ALL                   ((uint8_t)0x74)
#define GPIO_PA_PULLUP_BIT_ALL                   ((uint8_t)0x74)
#define GPIO_PA_PULLDOWN_BIT_ALL                 ((uint8_t)0x74)
#define GPIO_PA_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x74)
#define GPIO_PA_INPUT_BIT_ALL                    ((uint8_t)0x74)
#define GPIO_PA_FR1_BIT_ALL                      ((uint8_t)0x74)
#define GPIO_PA_FR2_BIT_ALL                      ((uint8_t)0x74)

#define GPIO_PB_OUTPUT_BIT_ALL                   ((uint8_t)0x78)
#define GPIO_PB_PULLUP_BIT_ALL                   ((uint8_t)0x78)
#define GPIO_PB_PULLDOWN_BIT_ALL                 ((uint8_t)0x78)
#define GPIO_PB_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x78)
#define GPIO_PB_INPUT_BIT_ALL                    ((uint8_t)0x78)
#define GPIO_PB_FR1_BIT_ALL                      ((uint8_t)0x78)

#define GPIO_PD_OUTPUT_BIT_ALL                   ((uint8_t)0x40)
#define GPIO_PD_PULLUP_BIT_ALL                   ((uint8_t)0x40)
#define GPIO_PD_PULLDOWN_BIT_ALL                 ((uint8_t)0x40)
#define GPIO_PD_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x40)
#define GPIO_PD_INPUT_BIT_ALL                    ((uint8_t)0x40)
#define GPIO_PD_FR1_BIT_ALL                      ((uint8_t)0x40)

#define GPIO_PE_OUTPUT_BIT_ALL                   ((uint8_t)0xD7)
#define GPIO_PE_PULLUP_BIT_ALL                   ((uint8_t)0xD7)
#define GPIO_PE_PULLDOWN_BIT_ALL                 ((uint8_t)0xD7)
#define GPIO_PE_OPEN_DRAIN_BIT_ALL               ((uint8_t)0xD7)
#define GPIO_PE_INPUT_BIT_ALL                    ((uint8_t)0xD7)
#define GPIO_PE_FR1_BIT_ALL                      ((uint8_t)0xD7)
...
#define GPIO_PI_OUTPUT_BIT_ALL                   ((uint8_t)0x08)
#define GPIO_PI_PULLUP_BIT_ALL                   ((uint8_t)0x08)
#define GPIO_PI_PULLDOWN_BIT_ALL                 ((uint8_t)0x08)
#define GPIO_PI_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x08)
#define GPIO_PI_INPUT_BIT_ALL                    ((uint8_t)0x08)

#define GPIO_PJ_OUTPUT_BIT_ALL                   ((uint8_t)0xE1)
#define GPIO_PJ_PULLUP_BIT_ALL                   ((uint8_t)0xE1)
#define GPIO_PJ_PULLDOWN_BIT_ALL                 ((uint8_t)0xE1)
#define GPIO_PJ_OPEN_DRAIN_BIT_ALL               ((uint8_t)0xE1)
#define GPIO_PJ_INPUT_BIT_ALL                    ((uint8_t)0xE1)
...
#define IS_GPIO_PA_DATA_BIT(param)      (((param) == GPIO_BIT_2)|| \
                                         ((param) == GPIO_BIT_4)|| \
                                         ((param) == GPIO_BIT_5)|| \
                                         ((param) == GPIO_BIT_6))

#define IS_GPIO_PB_DATA_BIT(param)      (((param) == GPIO_BIT_3)|| \
                                         ((param) == GPIO_BIT_4)|| \
                                         ((param) == GPIO_BIT_5)|| \
                                         ((param) == GPIO_BIT_6))

#define IS_GPIO_PD_DATA_BIT(param)      (((param) == GPIO_BIT_6))
...
#define IS_GPIO_PI_DATA_BIT(param)      (((param) == GPIO_BIT_3))
