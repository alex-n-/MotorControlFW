...
#ifndef __TMPM375_SBI_H
#define __TMPM375_SBI_H
...
#define TSB_SBI0                        TSB_SBI
#define SBI_CHANNEL_NUMBER              1U
#define IS_SBI_PERIPH(param)            ((param) == TSB_SBI)
