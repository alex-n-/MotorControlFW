...
#ifndef __TMPM375_TMRB_H
#define __TMPM375_TMRB_H
...
#define IS_TMRB_IN_PERIPH(param)     (((param) == TSB_TB4) || \
                                      ((param) == TSB_TB7))
...
#define IS_TMRB_OUT_PERIPH(param)    ((param) == TSB_TB7)
