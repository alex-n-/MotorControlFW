...
#ifndef __TMPM376_FC_H
#define __TMPM376_FC_H

#if !defined(TSB_M376FY) && !defined(TSB_M376FD)
#define TSB_M376FD
#endif
...
/** @defgroup FC_Exported_Constants
  * @{
  */
#define FLASH_PAGE_SIZE                 ((uint32_t)0x00000200)  /* Page Size 128 words */
...
#define IS_FC_BLOCK_NUM(param)          (((param) == FC_BLOCK_2) || \
                                         ((param) == FC_BLOCK_3) || \
                                         ((param) == FC_BLOCK_4) || \
                                         ((param) == FC_BLOCK_5))
#endif
