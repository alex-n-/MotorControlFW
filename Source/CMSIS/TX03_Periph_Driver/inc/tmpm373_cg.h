...
#ifndef __TMPM373_CG_H
#define __TMPM373_CG_H
...
#define IS_CG_PHIT0_SRC(param)  (((param) == CG_PHIT0_SRC_FGEAR) || \
    ...
    typedef enum {
        ...
        CG_INT_SRC_3 = 3U,
#endif
#if defined(__TMPM370_CG_H) || defined(__TMPM372_CG_H) || defined(__TMPM373_CG_H)
        CG_INT_SRC_4 = 4U,
#endif
        CG_INT_SRC_5 = 5U,
        CG_INT_SRC_6 = 6U,
...
#define IS_CG_INT_SRC(param)    (((param) == CG_INT_SRC_3) || \
                                 ...
                                 ((param) == CG_INT_SRC_E) || \
                                 ((param) == CG_INT_SRC_F))
#elif defined(__TMPM373_CG_H)
#define IS_CG_INT_SRC(param)    (((param) == CG_INT_SRC_4) || \
                                 ((param) == CG_INT_SRC_5) || \
                                 ((param) == CG_INT_SRC_6) || \
                                 ((param) == CG_INT_SRC_7) || \
                                 ((param) == CG_INT_SRC_C) || \
                                 ...
                                 ((param) == CG_INT_SRC_E) || \
                                 ((param) == CG_INT_SRC_F))
#elif defined(__TMPM374_CG_H)
#define IS_CG_INT_SRC(param)    (((param) == CG_INT_SRC_5) || \
                                 ((param) == CG_INT_SRC_6) || \
                                 ((param) == CG_INT_SRC_7) || \
                                 ((param) == CG_INT_SRC_C) || \
                                 ((param) == CG_INT_SRC_D) || \
