...
#ifndef __TMPM372_GPIO_H
#define __TMPM372_GPIO_H
...
#define GPIO_PD_OUTPUT_BIT_ALL                   ((uint8_t)0x70)
#define GPIO_PD_PULLUP_BIT_ALL                   ((uint8_t)0x70)
#define GPIO_PD_PULLDOWN_BIT_ALL                 ((uint8_t)0x70)
#define GPIO_PD_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x70)
#define GPIO_PD_INPUT_BIT_ALL                    ((uint8_t)0x70)
#define GPIO_PD_FR1_BIT_ALL                      ((uint8_t)0x70)
#define GPIO_PD_FR2_BIT_ALL                      ((uint8_t)0x10)
...
#define IS_GPIO_PD_DATA_BIT(param)      (((param) == GPIO_BIT_4)|| \
                                         ((param) == GPIO_BIT_5)|| \
                                         ((param) == GPIO_BIT_6))
