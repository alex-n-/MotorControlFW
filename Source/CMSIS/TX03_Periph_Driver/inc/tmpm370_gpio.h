...
#ifndef __TMPM370_GPIO_H
#define __TMPM370_GPIO_H
...
#define GPIO_PB_PULLUP_BIT_ALL                   ((uint8_t)0xEF)
#define GPIO_PB_PULLDOWN_BIT_ALL                 ((uint8_t)0x10)
