...
#define CR_TRGSEL_MASK        ((uint32_t)0xFFFFFFFD)
...
#define MOD_TBRSWR_MASK       ((uint32_t)0xFFFFFFBF)

#define MOD_TBCP_SET          ((uint32_t)0x00000020)
...
/**
  ...
  * @param  TBx: Select the TMRB channel.
  *   This parameter can be one of the following values:
  *   TSB_TB0, TSB_TB1, TSB_TB2, TSB_TB4, TSB_TB5, TSB_TB6, TSB_TB7.
...
/**
  ...
  * @param  TBx: Select the TMRB channel.
  *   This parameter can be one of the following values:
  *   TSB_TB0, TSB_TB1, TSB_TB2, TSB_TB4, TSB_TB6, TSB_TB7.
