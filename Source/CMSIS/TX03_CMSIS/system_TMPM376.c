...
#define OSCCR_WUODR_EXT  (0xFFF00000UL)   /* OSCCR<WUPODR13:2> = MAX */
#define OSCCR_WUODR_PLL  (0x1F400000UL)   /* OSCCR<WUPODR13:2> = 2000, warm-up time is 200us @ EXTALH = 10MHz */
