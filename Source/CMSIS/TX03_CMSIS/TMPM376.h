...
#ifndef __TMPM376_H__
#define __TMPM376_H__
...
/******  TMPM376 Specific Interrupt Numbers *******************************************************************/
  ...
  INTADASFT_IRQn                = 54,        /*!< ADC0 conversion started by software is finished             */
  INTADBSFT_IRQn                = 55,        /*!< ADC1 conversion started by software is finished             */
  INTADATMR_IRQn                = 56,        /*!< ADC0 conversion triggered by timer is finished              */
  ...
  INTSBI0_IRQn                  = 78         /*!< Serial bus interface 0                                      */
} IRQn_Type;
...
#include "system_TMPM376.h"                 /* TMPM376 System                                      */
...
typedef struct
{
  uint32_t CR0;                    /*!< SBI Control Register 0                       */
  uint32_t CR1;                    /*!< SBI Control Register 1 (I2C Mode)            */
  uint32_t DBR;                    /*!< SBI Data Buffer Register                     */
  uint32_t I2CAR;                  /*!< SBI I2C Bus Address Register                 */
union {
  uint32_t CR2;                    /*!< SBI Control Register 2 (I2C Mode)            */
  uint32_t SR;                     /*!< SBI Status Register (I2C Mode)               */
  };
  uint32_t BR0;                    /*!< SBI Baud Rate Register 0                     */
} TSB_SBI_TypeDef;
